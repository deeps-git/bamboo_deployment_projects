...
echo "Please enter bamboo_build_key"
read bamboo_build_key
echo "Please enter bamboo_script_key"
read bamboo_script_key
echo "Please enter bamboo_gitrepo_name"
read bamboo_gitrepo_name
echo "Please enter bamboo_maven_path"
read bamboo_maven_path
echo "Please enter bamboo_function_ext"
read bamboo_function_ext
echo "Please enter bamboo_repo_url"
read bamboo_repo_url
echo "Please enter bamboo_scrip_path"
read bamboo_scrip_path
